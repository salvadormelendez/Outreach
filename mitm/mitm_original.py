...
def check_code(w_code):
	...
	return 0
        ...
        msg = 'tput setaf 1'
        os.system(msg)
        print 'Invalid Workshop Code!... Try again!\n'
        msg = 'tput sgr0'
        os.system(msg)
	return 1
...
def check_answer(answer, num):
    ...
    if(answer == mitm_answers[num]):
        if (lock_answer != 1):
            ...
            msg = 'tput setaf 2'
            os.system(msg)
            print '\nYou are right!!!... Please answer the next question\n'
            msg = 'tput sgr0'
            os.system(msg)
            return 1
	else:
            ...
            msg = 'tput setaf 3'
            os.system(msg)
            print '\nYou are right!!!... Congratulations! You have unlocked the secret file(s) needed to complete this workshop.'
            msg = 'tput sgr0'
            os.system(msg)
            global workshop_num
	    if(workshop_num == 0):
...
while(lock_answer):
    for i in range(0,total_questions):
        ...
        while(ret_lock_answer == 0):
            msg = 'Question #' + str(i+1) + ': ' + mitm_questions[mitm_shuffle[i]] + '\n'
